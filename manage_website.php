   ...
   <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/myimages/nagendra.jpg<?=$website_logo?>" style="height:35%;width:25%;">
                          ...
                          <input type="file" class="form-control" name="website_image">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/nagendra.jpg<?=$invoice_logo?>" style="height:35%;width:35%;">
                          ...
                          <input type="file" class="form-control" name="invoice_image">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/nagendra.jpg<?=$login_logo?>" style="height:35%;width:35%;">
                          ...
                          <input type="file" class="form-control" name="login_image">
                                          ...
                                          <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/nagendra.jpg<?=$background_login_image?>" style="height:35%;width:35%;">
