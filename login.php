...
?>
    ...
    <div id="main-wrapper">
        <div class="unix-login">
            ...
            <div class="container-fluid" style="background-image: url('/assets/myimages/nagendra.jpg');
 background-color: #ffffff;background-size:cover">
                <div class="row">
                    <div class="col-lg-4 ml-auto">
                        <div class="login-content">
                            <div class="login-form">
                                <center><img src="./assets/myimages/nagendra.jpg" style="width: 100%;"></center><br>
